...
const CACHE='aslima-v1006-single-background-arch';
const VERSION='1006';
...
const CORE=[
  './','./index.html','./preview.html','./admin.html','./admin-manifest.webmanifest','./assets/aslima-admin-icon.svg','./assets/aslima-mark.svg','./assets/focus-calendar.svg','./assets/focus-mosque.svg','./assets/focus-bell.svg','./assets/focus-fidelity-v987.css?v=1006','./assets/aslima-focus-background-v1.png','./data/vric-prayer-times.json',
