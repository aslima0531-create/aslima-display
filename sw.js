...
const CACHE='aslima-v1001-focus-dock-details';
const VERSION='1001';
...
const CORE=[
  './','./index.html','./preview.html','./admin.html','./admin-manifest.webmanifest','./assets/aslima-admin-icon.svg','./assets/aslima-mark.svg','./assets/focus-arch-overlay.svg','./assets/focus-calendar.svg','./assets/focus-mosque.svg','./assets/focus-bell.svg','./assets/focus-fidelity-v987.css?v=1001','./assets/aslima-focus-background-v1.png','./data/vric-prayer-times.json',
