...
const CACHE='aslima-v995-focus-ring-shine';
const VERSION='995';
...
const CORE=[
  './','./index.html','./preview.html','./admin.html','./admin-manifest.webmanifest','./assets/aslima-admin-icon.svg','./assets/aslima-mark.svg','./assets/focus-arch-overlay.svg','./assets/focus-calendar.svg','./assets/focus-mosque.svg','./assets/focus-fidelity-v987.css','./assets/aslima-focus-background-v1.png','./data/vric-prayer-times.json',
