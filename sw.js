...
const CACHE='aslima-v983-focus-layout';
const VERSION='983';
...
const CORE=[
  './','./index.html','./preview.html','./admin.html','./admin-manifest.webmanifest','./assets/aslima-admin-icon.svg','./assets/aslima-mark.svg','./assets/focus-arch-overlay.svg','./assets/focus-calendar.svg','./data/vric-prayer-times.json',
