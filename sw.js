...
const CACHE='aslima-v1012-focus-supplementary-spacing';
const VERSION='1012';
...
const CORE=[
  './','./index.html','./preview.html','./admin.html','./admin-manifest.webmanifest','./assets/aslima-admin-icon.svg','./assets/aslima-mark.svg','./assets/focus-calendar.svg','./assets/focus-mosque.svg','./assets/focus-bell.svg','./assets/focus-fidelity-v987.css?v=1012','./assets/aslima-focus-background-v1.png','./data/vric-prayer-times.json',
