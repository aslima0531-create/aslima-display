/* ASLIMA v9.1.62 — verified masjid and ZIP-code discovery.
   The tracked pages load the scheduler directly and register sw.js?v=964. The
   worker upgrades existing controlled tablets without injecting another scheduler
   instance. Styles remain embedded directly in the HTML response. */
const CACHE='aslima-v967-interface-polish';
const VERSION='967';
...
const CORE=[
  ...
  './assets/audio/azaan-doha-fajr.mp3','./assets/audio/azaan-doha-dhuhr.mp3',
  './assets/audio/azaan-doha-asr.mp3','./assets/audio/azaan-doha-maghrib.mp3',
  './assets/audio/azaan-doha-isha.mp3','./assets/audio/dua-after-azaan.wav'
];
