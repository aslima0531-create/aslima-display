...
const CACHE='aslima-v1004-emerald-arch-background';
const VERSION='1004';
...
const CORE=[
  './','./index.html','./preview.html','./admin.html','./admin-manifest.webmanifest','./assets/aslima-admin-icon.svg','./assets/aslima-mark.svg','./assets/focus-arch-overlay.svg','./assets/focus-calendar.svg','./assets/focus-mosque.svg','./assets/focus-bell.svg','./assets/focus-fidelity-v987.css?v=1004','./assets/aslima-focus-background-v1.png','./data/vric-prayer-times.json',
