...
const CACHE='aslima-v1022-farooq-physical-tablet-layout';
const VERSION='1022';
...
const CORE=[
  './','./index.html','./preview.html','./admin.html','./admin-manifest.webmanifest','./assets/aslima-admin-icon.svg','./assets/aslima-mark.svg','./assets/focus-calendar.svg','./assets/focus-mosque.svg','./assets/focus-bell.svg','./assets/focus-fidelity-v987.css?v=1022','./assets/farooq-home-10in.css?v=1022','./assets/aslima-focus-background-v1.png','./data/vric-prayer-times.json',
  ...
  './assets/js/masjid-discovery-v962.js?v=963',
