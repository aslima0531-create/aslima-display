...
const CACHE='aslima-v986-focus-fidelity';
const VERSION='986';
...
const CORE=[
  './','./index.html','./preview.html','./admin.html','./admin-manifest.webmanifest','./assets/aslima-admin-icon.svg','./assets/aslima-mark.svg','./assets/focus-arch-overlay.svg','./assets/focus-calendar.svg','./assets/focus-mosque.svg','./data/vric-prayer-times.json',
